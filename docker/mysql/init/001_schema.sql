...
CREATE TABLE
    IF NOT EXISTS user_metrics (
        ...
        CONSTRAINT fk_user_metrics_user FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE,
        CONSTRAINT fk_user_metrics_metric FOREIGN KEY (metric_id) REFERENCES metrics (id) ON DELETE CASCADE ON UPDATE CASCADE
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
...
CREATE TABLE
    IF NOT EXISTS form_submissions (
        ...
        CONSTRAINT fk_form_submissions_user FOREIGN KEY (user_id) REFERENCES users (id) ON DELETE CASCADE ON UPDATE CASCADE
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;

CREATE TABLE
    IF NOT EXISTS question_answers (
        id INT NOT NULL AUTO_INCREMENT,
        ...
        CONSTRAINT fk_question_answers_submission FOREIGN KEY (submission_id) REFERENCES form_submissions (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE
    IF NOT EXISTS question_metrics_affects (
        id INT NOT NULL AUTO_INCREMENT,
        question_id INT NOT NULL,
        ...
        CONSTRAINT fk_question_metrics_affects_question FOREIGN KEY (question_id) REFERENCES questions (id) ON DELETE CASCADE ON UPDATE CASCADE,
        CONSTRAINT fk_question_metrics_affects_option FOREIGN KEY (question_option_id) REFERENCES question_options (id) ON DELETE CASCADE ON UPDATE CASCADE,
        CONSTRAINT fk_question_metrics_affects_metric FOREIGN KEY (metric_id) REFERENCES metrics (id) ON DELETE CASCADE ON UPDATE CASCADE
    ) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_unicode_ci;
